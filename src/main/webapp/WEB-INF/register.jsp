...
<body>
	<nav class="navbar">
		...
		<a href="/ramen/menu" class="activeNavButton btn active">Menu</a> <a
			href="/ramen/location" class="nav-item btn">Location</a> <a
			href="/ramen/SOTW" class="nav-item btn">Soup Of The Week</a> <a
			href="/ramen/about" class="nav-item btn">About Us</a> <a href="#"
			class="nav-item btn">Suggestions</a>
		<div>
			<a href="/login" class="nav-logReg btn">Sign in</a> <a
				href="/register" class="nav-logReg btn">Register</a>
		</div>
	</nav>
